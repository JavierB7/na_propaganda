# acceso-y-operacion Specification

## Purpose

Autenticación de usuarios autorizados sin roles, aislamiento por RLS, atribución de escrituras, respaldo periódico de datos y mantenimiento del proyecto contra la pausa por inactividad.
