# registro-semanal Specification

## Purpose

Captura de mediciones semanales contra pieza o contra línea, definición de semana, reglas de grano y degradación aceptada, separación de mensajes de Meta y consultas en comentarios, integridad contra doble conteo, y carga histórica a nivel de línea.
