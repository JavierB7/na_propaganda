# catalogo-difusion Specification

## Purpose

Líneas de difusión y piezas publicitarias: alta, edición y desactivación de líneas; unidad de éxito por línea; alta de piezas con código autogenerado, fecha de subida, línea, estado activo e identificador opcional de anuncio de Meta para automatización futura.
